...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PACKET_LEN_WIDTH"

}

proc update_PARAM_VALUE.AUDIO_WIDTH { PARAM_VALUE.AUDIO_WIDTH } {
	# Procedure called to update AUDIO_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AUDIO_WIDTH { PARAM_VALUE.AUDIO_WIDTH } {
	# Procedure called to validate AUDIO_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.AUDIO_WIDTH { MODELPARAM_VALUE.AUDIO_WIDTH PARAM_VALUE.AUDIO_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AUDIO_WIDTH}] ${MODELPARAM_VALUE.AUDIO_WIDTH}
}
