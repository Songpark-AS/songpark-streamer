...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SIM_PKT_SIZE"
...
proc update_PARAM_VALUE.SIM_PKT_SIZE { PARAM_VALUE.SIM_PKT_SIZE } {
	# Procedure called to update SIM_PKT_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SIM_PKT_SIZE { PARAM_VALUE.SIM_PKT_SIZE } {
	# Procedure called to validate SIM_PKT_SIZE
	return true
}
...
proc update_MODELPARAM_VALUE.SIM_PKT_SIZE { MODELPARAM_VALUE.SIM_PKT_SIZE PARAM_VALUE.SIM_PKT_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SIM_PKT_SIZE}] ${MODELPARAM_VALUE.SIM_PKT_SIZE}
}
