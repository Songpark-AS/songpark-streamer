...
proc update_PARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH { PARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH } {
	# Procedure called to update C_FRM_SEQ_S_AXIS_TDATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH { PARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH } {
	# Procedure called to validate C_FRM_SEQ_S_AXIS_TDATA_WIDTH
	return true
}
...
proc update_PARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT { PARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT } {
	# Procedure called to update C_TO_AUD_M_AXI_START_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT { PARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT } {
	# Procedure called to validate C_TO_AUD_M_AXI_START_COUNT
	return true
}

proc update_PARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH { PARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH } {
	# Procedure called to update C_TO_AUD_M_AXI_TDATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH { PARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH } {
	# Procedure called to validate C_TO_AUD_M_AXI_TDATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH { MODELPARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH PARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH}] ${MODELPARAM_VALUE.C_FRM_SEQ_S_AXIS_TDATA_WIDTH}
}

proc update_MODELPARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH { MODELPARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH PARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH}] ${MODELPARAM_VALUE.C_TO_AUD_M_AXI_TDATA_WIDTH}
}
...
proc update_MODELPARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT { MODELPARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT PARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT}] ${MODELPARAM_VALUE.C_TO_AUD_M_AXI_START_COUNT}
}
