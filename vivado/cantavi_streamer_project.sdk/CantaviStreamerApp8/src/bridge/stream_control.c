...
void print_switch_param(void *eth_base){
 unsigned int d;
d = ReadReg(eth_base, ETH_UDP_REG2_OFFSET);
printf("SW_UDP Filter Table: PORT1: %d\n",d);
d = ReadReg(eth_base, ETH_UDP_REG3_OFFSET);
printf("SW_UDP Filter Table: PORT2: %d\n",d);
d = ReadReg(eth_base, ETH_UDP_REG4_OFFSET);
printf("SW_UDP Filter Table: PORT3: %d\n",d);
d = ReadReg(eth_base, ETH_UDP_REG5_OFFSET);
printf("SW_UDP Filter Table: PORT4: %d\n",d);
d = ReadReg(eth_base, ETH_UDP_REG6_OFFSET);
printf("SW_UDP Filter Table: PORT5: %d\n",d);
d = ReadReg(eth_base, ETH_UDP_REG7_OFFSET);
printf("SW_UDP Filter Table: PORT6: %d\n",d);
d = ReadReg(eth_base, ETH_UDP_REG8_OFFSET);
printf("SW_UDP Filter Table: PORT7: %d\n",d);
d = ReadReg(eth_base, ETH_UDP_REG9_OFFSET);
