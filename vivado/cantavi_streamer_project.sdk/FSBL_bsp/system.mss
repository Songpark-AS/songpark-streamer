...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = FILTER_IIR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AudioProcessingChannel_FILTER_IIR_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Volume_Pregain
 PARAMETER DRIVER_VER = 1.0
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = adau1761_controller
 PARAMETER DRIVER_VER = 1.0
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = eth_udp_axi_arp_stack
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = eth_udp_axi_arp_stack_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = org_audio2eth_interleaved_packetizer
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = org_audio2eth_interl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = pmod_controller
 PARAMETER DRIVER_VER = 1.0
