...
void reset_adau1761(void) {
	info( "write adau1761 \n\r");
	info( "Adau1761 Device address is::0x%08X!!!\n",AUDIO_BASE);
...
void init_adau1761_pll(void) {
    ...
    info( "init_adau1761()::Wait for PLL to lock \n\r");
    ...
    write_adau1761(0x401c, 0x21, 1);//correct
//    write_adau1761(0x401d, 0x66, 1); not needed we need to control the local input play back from the core vol
    ...
    write_adau1761(0x401e, 0x21, 1);//wrong but gives mono and better sound
...
int init_codec(void){
	    info( "Initializing reset_adau1761 \n\r");
	    reset_adau1761();
	    info("Initializing init_adau1761 \n\r");
	    init_adau1761();
	    info("Audio on adau1761 ready \n\r");
