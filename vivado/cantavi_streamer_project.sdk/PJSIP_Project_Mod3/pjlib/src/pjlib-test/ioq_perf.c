...
static int ioqueue_perf_test_imp(pj_bool_t allow_concur)
{
    ...
    {
        { pj_SOCK_DGRAM_SIG(), "udp", 1, 1},
        { pj_SOCK_DGRAM_SIG(), "udp", 1, 2},
        { pj_SOCK_DGRAM_SIG(), "udp", 1, 4},
        { pj_SOCK_DGRAM_SIG(), "udp", 1, 8},
        { pj_SOCK_DGRAM_SIG(), "udp", 2, 1},
        { pj_SOCK_DGRAM_SIG(), "udp", 2, 2},
        { pj_SOCK_DGRAM_SIG(), "udp", 2, 4},
        { pj_SOCK_DGRAM_SIG(), "udp", 2, 8},
        { pj_SOCK_DGRAM_SIG(), "udp", 4, 1},
        { pj_SOCK_DGRAM_SIG(), "udp", 4, 2},
        { pj_SOCK_DGRAM_SIG(), "udp", 4, 4},
        { pj_SOCK_DGRAM_SIG(), "udp", 4, 8},
        { pj_SOCK_DGRAM_SIG(), "udp", 4, 16},
...
/*
	{ pj_SOCK_DGRAM_SIG(), "udp", 32, 1},
	{ pj_SOCK_DGRAM_SIG(), "udp", 32, 1},
	{ pj_SOCK_DGRAM_SIG(), "udp", 32, 1},
	{ pj_SOCK_DGRAM_SIG(), "udp", 32, 1},
	{ pj_SOCK_DGRAM_SIG(), "udp", 1, 32},
	{ pj_SOCK_DGRAM_SIG(), "udp", 1, 32},
	{ pj_SOCK_DGRAM_SIG(), "udp", 1, 32},
	{ pj_SOCK_DGRAM_SIG(), "udp", 1, 32},
