...
const pj_uint16_t PJ_SOCK_DGRAM_SIG	= KSockDatagram;
const pj_uint16_t PJ_SOCK_DGRAM_MED	= KSockDatagram+1;
				   ...
				   pj_sock_t *p_sock)
{
	...
	else if (type == pj_SOCK_DGRAM_MED() || type == pj_SOCK_DGRAM_SIG())
