...
//				    	if (level == 4) { \
//				    		printf("INFO::"); pj_log_wrapper_##level(arg); \
//				    	}else if (level == 3){ \
//				    		printf("DEBUG::"); pj_log_wrapper_##level(arg); \
//				    	 } else if (level == 2){ \
//							printf("WARN::"); pj_log_wrapper_##level(arg); \
//						 } else if (level == 1){ \
//							printf("ERROR::"); pj_log_wrapper_##level(arg); \
//						 } \
//				    } \
//				} while (0)
//
