...
extern const pj_uint16_t PJ_SOCK_DGRAM_MED;
extern const pj_uint16_t PJ_SOCK_DGRAM_SIG;
 ...
 */
    ...
    PJ_DECL(int) pj_SOCK_DGRAM_MED(void);
    PJ_DECL(int) pj_SOCK_DGRAM_SIG(void);
