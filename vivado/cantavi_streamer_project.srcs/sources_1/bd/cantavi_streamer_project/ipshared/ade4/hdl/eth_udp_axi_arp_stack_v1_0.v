 ...
 **/
module user_eth_udp_axi_arp_stack_v1_0#(// Parameters of Axi Slave Bus Interface S00_AXI
...
wire [15:0]  sync_rx_pkt_count;
wire [15:0]  audio_rx_pkt_count;
wire [15:0]  mock_rx_pkt_count;
            
        
wire [15:0]  sync_tx_pkt_count;
wire [15:0]  audio_tx_pkt_count;

wire [31:0]  rx_stk_state;
wire [31:0]  bus_status;


wire  effective_sync_tx_enable;

assign media_pkt_tx_en_out = udp_stream_tx_enable;
...
sync_reset_inst (
    .clk(clk_125_in),
    .rst((~s00_axi_aresetn)||reset||rst_in),
//    .rst(reset),
//.rst(~reset_n),
...
//    .cfg_time_sync_udp_ip_length(s_time_sync_payload_length),
    ...
    .sync_rx_pkt_count(sync_rx_pkt_count),
    .audio_rx_pkt_count(audio_rx_pkt_count),
    .mock_rx_pkt_count(mock_rx_pkt_count),
            
        
    .sync_tx_pkt_count(sync_tx_pkt_count),
    .audio_tx_pkt_count(audio_tx_pkt_count),
    
    .rx_stk_state(rx_stk_state),
...
//        .rx_packets(rx_packets),
        ...
        // ARP requests
        .in_arp_request_valid(arp_request_valid),
        .out_arp_request_ready(arp_request_ready),
        .in_arp_request_ip(arp_request_ip),
        .out_arp_response_valid(arp_response_valid),
        .in_arp_response_ready(arp_response_ready),
        .out_arp_response_error(arp_response_error),
        .out_arp_response_mac(arp_response_mac),
